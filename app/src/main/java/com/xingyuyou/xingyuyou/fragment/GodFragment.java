...
public class GodFragment extends BaseFragment {
    ...
    protected View initView() {
        ...
        mAdapter = new GodAdapter(mActivity,mDatas);
        //神轮播图
        View view2 = View.inflate(mActivity, R.layout.part_god_fragment_header, null);
        InfiniteViewPager viewPager = (InfiniteViewPager) view2.findViewById(R.id.id_viewpager);
        ...
        viewPager.setOnItemClickListener(new InfiniteViewPager.OnItemClickListener() {
            @Override
            public void onItemClick(int position) {
                Toast.makeText(mActivity, "hh"+position, Toast.LENGTH_SHORT).show();
            }
        });
