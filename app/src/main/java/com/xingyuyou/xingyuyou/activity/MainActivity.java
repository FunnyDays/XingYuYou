...
public class MainActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        bottomNavigationBar
                .addItem(new BottomNavigationItem(R.drawable.ic_launcher, "推荐").setActiveColorResource(R.color.colorPrimary))
    ...
    private ArrayList<BaseFragment> getFragments() {
        ...
        fragments.add(OneFragment.newInstance("分类"));
        fragments.add( TwoFragment.newInstance("榜单"));
        fragments.add(FourFragment.newInstance("管理"));
